...
// Base: grama (g). 1 unidade = X gramas.
...
export default function WeightConverter() {
  ...
  const [to, setTo] = React.useState("lb")
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="weight-from">Unidade de origem</Label>
          <Select value={from} onValueChange={setFrom}>
            <SelectTrigger id="weight-from" className="w-full">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {units.map((u) => (
        ...
        <div className="grid items-end gap-3 sm:grid-cols-[1fr_auto_1fr_auto]">
          <div className="space-y-2">
            ...
            <Select value={to} onValueChange={setTo}>
              <SelectTrigger id="weight-to" className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {units.map((u) => (
